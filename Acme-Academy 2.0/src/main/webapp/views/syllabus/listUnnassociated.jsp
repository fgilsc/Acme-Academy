...
<display:table name="syllabi" pagesize="5" class="displaytag" requestURI="${requestUri}" id="syllabus">
	...
	<display:column>
		<input type="button" name="associate" value="<spring:message code="syllabus.associate"/>" 
			onclick="javascript: window.location.replace('syllabus/lecturer/associate.do?syllabusId=${syllabus.id}')"/>
	</display:column>
